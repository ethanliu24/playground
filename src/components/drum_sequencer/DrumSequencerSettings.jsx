...
export default function DrumSequencerSettings(props) {
  ...
  return (
    <div className="sequencer-settings-container">
      <img src={icons.play} id="sequencer-play-btn" className="icon" onClick={props.handlePlay} />
      ...
      <select name="bars" id="bars-selector" className="dropdown-selector channel-rack-ui">
